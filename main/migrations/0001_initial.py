# Generated by Django 3.1.5 on 2021-01-06 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasline', models.CharField(default='', max_length=100, verbose_name='Слоган')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('genres', models.ManyToManyField(to='main.Ganre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
